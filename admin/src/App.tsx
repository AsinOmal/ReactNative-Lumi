    ...
    <BrowserRouter>
      <Layout user={user} onSignOut={signOutUser}>
        <Routes>
          ...
          <Route path={ROUTES.PACK_NEW}      element={<PlaceholderScreen title="New Pack Editor" />} />
          <Route path={ROUTES.PACK_EDIT}     element={<PlaceholderScreen title="Pack Editor" />} />
          <Route path={ROUTES.MODELS}        element={<PlaceholderScreen title="Models" />} />
          <Route path={ROUTES.MODEL_NEW}     element={<PlaceholderScreen title="New Model" />} />
          <Route path={ROUTES.MODEL_EDIT}    element={<PlaceholderScreen title="Model Editor" />} />
