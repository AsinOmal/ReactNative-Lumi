  ...
  return (
    <div className="pack-editor">
      ...
      <div className="pack-editor__body">
        ...
        {/* Row 1 — Details + Words */}
        <div className="pack-editor__row--top">
        ...
        {/* Row 2 — Colours: gradient swatch + two pickers inline */}
        <div className="pack-editor__card">
          <h2 className="pack-editor__section-title">Colours</h2>
          <div className="pack-editor__colours-row">
            <div
        ...
        {/* Row 3 — Art images: three cards side by side */}
        <div className="pack-editor__row--art">
          <div className="pack-editor__card">
            <h2 className="pack-editor__section-title">Cover Art</h2>
            <p className="pack-editor__section-subtitle">
            ...
            {form.coverImageUrl && (
              <img
                ...
                className="pack-editor__art-preview"
              />
            )}
            <FileUploader
          ...
          <div className="pack-editor__card">
            <h2 className="pack-editor__section-title">Gate Art</h2>
            <p className="pack-editor__section-subtitle">
              Full-bleed background on the locked-pack screen. Portrait, 9:16.
            </p>
            {form.gateImageUrl && (
              <img
          ...
          <div className="pack-editor__card">
            <h2 className="pack-editor__section-title">Detail Art</h2>
            <p className="pack-editor__section-subtitle">
            ...
            {detailProgress !== null && detailProgress < 100 && (
              <p className="pack-editor__progress">Uploading… {detailProgress}%</p>
            )}
          </div>
        </div>
