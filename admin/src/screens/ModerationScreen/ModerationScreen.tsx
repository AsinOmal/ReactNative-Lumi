    ...
    <div className="moderation">
      ...
      <div className="moderation__section">
        ...
        <p className="moderation__section-desc">
          Words on this list are blocked from triggering AR models across all
          users.
        </p>
      ...
      <div className="moderation__section">
        ...
        <p className="moderation__section-desc">
          Scan events that triggered the safety layer. Mark as reviewed once
          actioned.
        </p>
              ...
              <tbody>
                {flaggedEvents.map((evt) => (
                  <tr key={evt.id} className="moderation__row">
                    ...
                    <td className="moderation__uid">
                      {evt.userEmail || evt.uid}
                    </td>
                    <td>
                      {evt.timestamp.toLocaleDateString('en-US', {
                        month: 'short',
                        day: 'numeric',
                      })}
                    </td>
