    ...
    <div className="ua-card">
      ...
      <div className="ua-card__chart">
        <ResponsiveContainer width="100%" height={200}>
          <AreaChart data={data} margin={{ top: 4, right: 4, left: -20, bottom: 0 }}>
            ...
            />
            <Area type="monotone" dataKey="activeUsers" name="Active" stroke="#6366F1" strokeWidth={2} fill="url(#gradActive)" />
      ...
      <div className="ua-card__legend">
        <div className="ua-card__legend-item">
          <span className="ua-card__legend-dot" style={{ background: '#6366F1' }} />
