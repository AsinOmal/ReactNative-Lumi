...
const BAR_COLORS = ['#6366F1', '#3B82F6', '#10B981', '#F59E0B', '#EF4444', '#14B8A6', '#8B5CF6', '#F97316'];
      ...
      <div className="tw-card__chart">
        <ResponsiveContainer width="100%" height={220}>
          <BarChart data={data} layout="vertical" margin={{ top: 0, right: 16, left: 0, bottom: 0 }}>
            ...
            <YAxis type="category" dataKey="word" tick={{ fontSize: 12, fill: wordTick }} tickLine={false} axisLine={false} width={80} />
            <Tooltip
              contentStyle={{
