  ...
  return (
    <div className="analytics">
      ...
      <div className="analytics__chart-card">
        <p className="analytics__chart-title">Daily Active Users — last 14 days</p>
        <p className="analytics__chart-sub">Grouped by each user's last-active date</p>
        ...
        <p className="analytics__note">
          For precise historical DAU, a pre-aggregation Cloud Function is needed.
          This chart approximates DAU using each user's <code>lastActive</code> timestamp.
        </p>
      </div>
    </div>
  );
...
const KpiBlock: React.FC<{ label: string; value: number | string }> = ({ label, value }) => (
