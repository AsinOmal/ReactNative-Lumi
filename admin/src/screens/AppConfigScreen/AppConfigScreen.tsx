...
interface ConstRow {
  key: keyof Omit<GameConstants, 'dailyWordList'>;
  label: string;
  description: string;
  min: number;
}
...
const FLAGS: FlagRow[] = [
  {
    ...
    description:
      'Show a maintenance banner in the mobile app. AR features remain accessible.',
    danger: true,
  },
  {
  ...
  },
  {
    ...
    description:
      'Allow users to see and purchase premium content packs (Dinosaurs, Space).',
  },
  {
    key: 'arGamesEnabled',
    label: 'AR Games Enabled',
    description:
      'Enable Make a Meal and Scan & Count games from the home screen.',
  },
];
...
const CONST_ROWS: ConstRow[] = [
  {
    ...
    description: 'OCR capture frequency. Default: 1000.',
    min: 200,
  },
  {
    key: 'hazardCheckIntervalMs',
    label: 'Hazard Check Interval (ms)',
    description: 'Safety classification frequency. Default: 5000.',
    min: 1000,
  },
  {
    key: 'hazardCooldownMs',
    label: 'Hazard Cooldown (ms)',
    description: 'Re-alert suppression window after dismiss. Default: 30000.',
    min: 0,
  },
  {
    key: 'arGameDurationSec',
    label: 'AR Game Duration (sec)',
    description: 'Word Find timer length. Default: 60.',
    min: 10,
  },
];
...
export const AppConfigScreen: React.FC = () => {
  ...
  return (
    <div className="app-config">
      <PageHeader
        title="App Config"
        subtitle="Feature flags and game constants — changes take effect on next app launch"
      />
      ...
      <div className="app-config__card">
        <div className="app-config__header">
          ...
          <div>
            ...
            <p className="app-config__card-sub">
              Stored in <code>/adminConfig/featureFlags</code>. Mobile reads on
              launch.
            </p>
          </div>
        </div>
        <div className="app-config__rows">
          {FLAGS.map((flag) => (
            <div
              key={flag.key}
              className={`app-config__row ${
                flag.danger && config[flag.key] ? 'app-config__row--danger' : ''
              }`}
            >
      ...
      <div className="app-config__card">
        <div className="app-config__header">
          ...
          <div>
            ...
            <p className="app-config__card-sub">
              Stored in <code>/adminConfig/gameConstants</code>. Mobile reads on
              launch.
            </p>
          </div>
        </div>
        <div className="app-config__rows">
            ...
            <div key={row.key} className="app-config__row">
              ...
              <input
                ...
                onBlur={(e) =>
                  updateConstants({
                    [row.key]:
                      Number(e.target.value) || DEFAULT_CONSTANTS[row.key],
                  })
                }
              />
            </div>
          ...
          <div className="app-config__row app-config__row--stacked">
            <div className="app-config__row-info">
              ...
              <p className="app-config__row-desc">
                Comma-separated words that override the date-seeded word of the
                day rotation.
              </p>
            </div>
            <textarea
