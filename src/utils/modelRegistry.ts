...
export interface ModelEntry {
  ...
  emoji: string;                      // display emoji for HomeScreen
}
...
export const MODEL_REGISTRY: Record<ModelKey, ModelEntry> = {
  ...
  grape:      { source: require('../assets/models/fruits/grape.glb'),      scale: [0.012, 0.012, 0.012],      position: [0, 0.0, -1.0],  syllables: ['Grape'],                  audio: 'grape.mp3',      emoji: '🍇' },
  lemon:      { source: require('../assets/models/fruits/lemon.glb'),      scale: [0.038, 0.038, 0.038],      position: [0, 0.0, -1.0],  syllables: ['Lem', 'on'],              audio: 'lemon.mp3',      emoji: '🍋' },
  mango:      { source: require('../assets/models/fruits/mango.glb'),      scale: [0.60,  0.60,  0.60 ],      position: [0, 0.0, -0.35], syllables: ['Man', 'go'],              audio: 'mango.mp3',      emoji: '🥭' },
  orange:     { source: require('../assets/models/fruits/orange.glb'),     scale: [0.60,  0.60,  0.60 ],      position: [0, 0.0, -0.35], syllables: ['Or', 'ange'],             audio: 'orange.mp3',     emoji: '🍊' },
  pineapple:  { source: require('../assets/models/fruits/pineapple.glb'),  scale: [3.5,   3.5,   3.5  ],      position: [0, 0.0, -0.8],  syllables: ['Pine', 'ap', 'ple'],      audio: 'pineapple.mp3',  emoji: '🍍' },
  strawberry: { source: require('../assets/models/fruits/strawberry.glb'), scale: [0.60,  0.60,  0.60 ],      position: [0, 0.0, -1.0],  syllables: ['Straw', 'ber', 'ry'],     audio: 'strawberry.mp3', emoji: '🍓' },
  watermelon: { source: require('../assets/models/fruits/watermelon.glb'), scale: [0.052, 0.052, 0.052],      position: [0, 0.0, -1.0],  syllables: ['Wa', 'ter', 'mel', 'on'], audio: 'watermelon.mp3', emoji: '🍉' },
};
