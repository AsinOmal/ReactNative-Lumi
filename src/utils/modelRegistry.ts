...
export const MODEL_REGISTRY: Record<ModelKey, ModelEntry> = {
  ...
  apple:      { source: require('../assets/models/fruits/apple.glb'),      scale: [0.0037, 0.0037, 0.0037], position: [0,  0.0, -1.0] },
  banana:     { source: require('../assets/models/fruits/banana.glb'),     scale: [0.00065, 0.00065, 0.00065], position: [0, 0.0, -1.0] },
  ...
  mango:      { source: require('../assets/models/fruits/mango.glb'),      scale: [0.20,  0.20,  0.20 ], position: [0,  0.0, -0.35] },
  orange:     { source: require('../assets/models/fruits/orange.glb'),     scale: [0.20,  0.20,  0.20 ], position: [0,  0.0, -0.35] },
