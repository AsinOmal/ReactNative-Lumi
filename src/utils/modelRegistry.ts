...
export const MODEL_REGISTRY: Record<ModelKey, ModelEntry> = {
  ...
  mango:      { source: require('../assets/models/fruits/mango.glb'),      scale: [0.20,  0.20,  0.20 ],      position: [0, 0.0, -0.35], syllables: ['Man', 'go'],              audio: 'mango.mp3',      emoji: '🥭' },
  orange:     { source: require('../assets/models/fruits/orange.glb'),     scale: [0.20,  0.20,  0.20 ],      position: [0, 0.0, -0.35], syllables: ['Or', 'ange'],             audio: 'orange.mp3',     emoji: '🍊' },
