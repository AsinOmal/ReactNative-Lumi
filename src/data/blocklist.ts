...
export const STATIC_BLOCKLIST: string[] = [
  ...
  'dick', 'cock', 'pussy', 'whore', 'slut', 'piss', 'crap', 'prick',
  // Slurs (abbreviated — only identifiable tokens)
  'nigga', 'nigger', 'fag', 'faggot', 'retard', 'spic', 'kike', 'chink',
  // Violence / self-harm terms
  'kill', 'stab', 'rape', 'murder', 'suicide', 'drug', 'drugs', 'cocaine',
  'heroin', 'meth', 'porn', 'sex', 'nude', 'naked', 'boobs', 'penis', 'vagina',
];
