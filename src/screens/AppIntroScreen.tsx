...
export const AppIntroScreen: React.FC = () => {
  ...
  const contentSlides: Slide[] = [
    { icon: 'scan-outline', title: strings.INTRO_SCAN_TITLE, body: strings.INTRO_SCAN_BODY },
    { icon: 'game-controller-outline', title: strings.INTRO_PLAYGROUND_TITLE, body: strings.INTRO_PLAYGROUND_BODY },
    { icon: 'shield-checkmark-outline', title: strings.INTRO_PARENT_TITLE, body: strings.INTRO_PARENT_BODY },
  ];
  ...
  return (
    <View style={[styles.root, { paddingTop: insets.top }]}>
      ...
      <TouchableOpacity style={[styles.skip, { top: insets.top + 8 }]} onPress={finish}>
      ...
      >
        ...
        <View style={styles.slide}>
          ...
          <View style={styles.langRow}>
            ...
            >
              <Text style={[styles.langBtnText, selected === 'en' && styles.langBtnTextActive]}>
                {strings.INTRO_LANG_ENGLISH}
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={[styles.langBtn, selected === 'si' && styles.langBtnActive]}
              onPress={() => setSelected('si')}
              accessibilityRole="radio"
              accessibilityState={{ selected: selected === 'si' }}
            >
              <Text style={[styles.langBtnText, selected === 'si' && styles.langBtnTextActive]}>
          ...
          {selected === 'si' && (
            <View style={styles.disclaimer}>
              <Text style={styles.disclaimerText}>{strings.INTRO_LANG_DISCLAIMER}</Text>
            </View>
          )}
        </View>
      </ScrollView>
