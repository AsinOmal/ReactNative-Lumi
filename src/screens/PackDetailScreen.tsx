      ...
      <View style={styles.container}>
        ...
        <ScrollView contentContainerStyle={[styles.scroll, { paddingBottom: insets.bottom + 40 }]}>
          <View style={styles.lockCard}>
            ...
            <Text style={styles.lockBody}>Unlock {pack.name} to scan, discover, and play with all {pack.wordCount} 3D models!</Text>
...
const styles = StyleSheet.create({
  ...
  packName: { flex: 1, textAlign: 'center', fontFamily: 'Fredoka-Bold', fontSize: 24, color: '#FFF' },
  body:     { flex: 1 },
  ...
  // Premium lock card
  lockCard: {
    backgroundColor: colors.backgroundCard, borderRadius: 28, margin: 16, padding: 28,
    alignItems: 'center', gap: 12,
    shadowColor: colors.primary, shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.1, shadowRadius: 16, elevation: 4,
  },
  lockTitle:  { fontFamily: 'Fredoka-Bold', fontSize: 24, color: colors.textDark, textAlign: 'center' },
  lockBody:   { fontFamily: 'Fredoka-Regular', fontSize: 15, color: colors.textMid, textAlign: 'center', lineHeight: 22 },
  chipRow:    { flexDirection: 'row', flexWrap: 'wrap', gap: 8, justifyContent: 'center', marginTop: 4 },
  chip:       { backgroundColor: '#EDE9FE', borderRadius: 20, paddingHorizontal: 12, paddingVertical: 6 },
  chipText:   { fontFamily: 'Fredoka-SemiBold', fontSize: 13, color: colors.primary },
  unlockBtn:  { borderRadius: 32, paddingHorizontal: 32, paddingVertical: 14, marginTop: 8, flexDirection: 'row', alignItems: 'center', gap: 10 },
