...
const styles = StyleSheet.create({
  ...
  statsCard:   { marginHorizontal: 20, marginTop: -44, backgroundColor: '#FFF', borderRadius: 24, flexDirection: 'row', alignItems: 'center', paddingVertical: 18, paddingHorizontal: 12, shadowColor: colors.primary, shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.12, shadowRadius: 20, elevation: 8 },
