...
export const styles = StyleSheet.create({
  ...
  progressLabel: { fontFamily: 'Fredoka-SemiBold', fontSize: 14, color: colors.textMid },
  ...
  card: {
    ...
    shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.16, shadowRadius: 12, elevation: 4,
  },
  ...
  cardDesc:        { fontFamily: 'Fredoka-Regular', fontSize: 13, color: colors.textMid, textAlign: 'center', lineHeight: 18 },

  doneRow:  { flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 2 },
  doneText: { fontFamily: 'Fredoka-SemiBold', fontSize: 12, color: colors.successDark },
});
