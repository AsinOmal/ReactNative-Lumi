...
import { updateUsername, USERNAME_MAX_LENGTH } from '../../services/userService';
...
export const EditUsernameModal: React.FC<EditUsernameModalProps> = ({
  visible, uid, currentUsername, onClose,
}) => {
      ...
      >
        <View style={[styles.sheet, { marginTop: insets.top + 24 }]}>
          <View style={styles.header}>
            ...
            <TouchableOpacity onPress={handleClose} accessibilityLabel="Close edit username">
              <Ionicons name="close" size={24} color={colors.textDark} />
            </TouchableOpacity>
          </View>

          <Text style={styles.hint}>This is the name shown in your profile and to admins.</Text>
          ...
          <TouchableOpacity
            style={[styles.submit, (!value.trim() || saving) && styles.submitDisabled]}
            onPress={handleSave}
...
const styles = StyleSheet.create({
  ...
  sheet:          { backgroundColor: '#FFF', borderRadius: 24, padding: 24, gap: 14, marginHorizontal: 16 },
  ...
  input:          { borderWidth: 1, borderColor: colors.primaryLight, borderRadius: 12, padding: 12, fontFamily: 'Fredoka-Regular', fontSize: 16, color: colors.textDark },
