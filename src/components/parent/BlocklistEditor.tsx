...
export const BlocklistEditor: React.FC = () => {
  ...
  const handleAdd = () => {
    ...
    if (user) {
      updateSettings(user.uid, {
        customBlocklist: [...settings.customBlocklist, word],
      });
    }
    setInput('');
  };
  ...
  const handleRemove = (word: string) => {
    if (user) {
      updateSettings(user.uid, {
        customBlocklist: settings.customBlocklist.filter((w) => w !== word),
      });
    }
  };
    ...
    <View style={styles.container}>
      <View style={styles.inputRow}>
        ...
        <TouchableOpacity
          style={styles.addBtn}
          onPress={handleAdd}
          accessibilityLabel="Add word to blocklist"
          ...
          renderItem={({ item }) => (
            <View style={styles.chip}>
              ...
              <TouchableOpacity
                ...
                accessibilityLabel={`Remove ${item} from blocklist`}
                accessibilityRole="button"
              >
